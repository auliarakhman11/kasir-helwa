...
@section('content')
        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">Ukuran</h4>
                                        ...
                                        @foreach ($ukuran as $d)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('deleteUkuran', $d->ukuran) }}"
    ...
    <form action="{{ route('addUkuran') }}" method="post">
        @csrf
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="myModalLabeltambah">Tambah Ukuran</h5>
                        ...
                        <div class="modal-body">
                            <div class="row form-group ">
                                ...
                                <div class="col-12 mb-2">
                                    ...
                                    <input type="number" name="ukuran" class="form-control" value="{{ $d->ukuran }}"
                                        required>
                                    <input type="hidden" name="ukuran_old" value="{{ $d->ukuran }}">
                                </div>
